...
aus dem OR-Demo-Portfolio, siehe csbb_presets.py), erweitert um den neuen
n_grades-Regler."""
...
SETTING_SPECS = {
    ...
    "n_grades_slider": SettingSpec("g", int, C.DEFAULT_N_GRADES, C.N_GRADES_MIN, C.N_GRADES_MAX),
...
def apply_preset(name):
    ...
    st.session_state["n_grades_slider"] = p["n_grades"]
